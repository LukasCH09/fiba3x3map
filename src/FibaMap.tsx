...
const FibaMap: React.FC<FibaMapProps> = ({apiKey}) => {
  ...
  useEffect(() => {
    ...
    .then(data => {
      ...
      const start = 0;
      const end = 8000; // Change this to the number of elements you want to copy
